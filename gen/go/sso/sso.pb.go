...
func (x *LoginRequest) GetNick() string {
	if x != nil {
		return x.Nick
	}
	return ""
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.card.RegisterRequest\x1a\x16.card.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.card.LoginRequest\x1a\x13.card.LoginResponse\x126\n" +
	"\aIsAdmin\x12\x14.card.IsAdminRequest\x1a\x15.card.IsAdminResponseB\x12Z\x10gen/go/sso;ssov1b\x06proto3"
...
var file_sso_sso_proto_goTypes = []any{
	(*RegisterRequest)(nil),  // 0: card.RegisterRequest
	(*RegisterResponse)(nil), // 1: card.RegisterResponse
	(*LoginRequest)(nil),     // 2: card.LoginRequest
	(*LoginResponse)(nil),    // 3: card.LoginResponse
	(*IsAdminRequest)(nil),   // 4: card.IsAdminRequest
	(*IsAdminResponse)(nil),  // 5: card.IsAdminResponse
}
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: card.Auth.Register:input_type -> card.RegisterRequest
	2, // 1: card.Auth.Login:input_type -> card.LoginRequest
	4, // 2: card.Auth.IsAdmin:input_type -> card.IsAdminRequest
	1, // 3: card.Auth.Register:output_type -> card.RegisterResponse
	3, // 4: card.Auth.Login:output_type -> card.LoginResponse
	5, // 5: card.Auth.IsAdmin:output_type -> card.IsAdminResponse
