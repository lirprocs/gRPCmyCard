...
const (
	Auth_Register_FullMethodName = "/card.Auth/Register"
	Auth_Login_FullMethodName    = "/card.Auth/Login"
	Auth_IsAdmin_FullMethodName  = "/card.Auth/IsAdmin"
)
